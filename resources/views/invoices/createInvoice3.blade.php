...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label for="currencyExchangeRate" class="form-label">سعر العملة الأجنبية
                                            بالمصرى الان</label>
                                        <input required class="form-control" step="any" type="number"
                                            step="any" name="currencyExchangeRate" id="currencyExchangeRate"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4" style="margin-top: -120px">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label for="findTotalt2Amount" class="form-label">إجمالى الضريبة النسبية
                                                بالجنيه
                                            </label>
                                            <input type="number" class="form-control" step="any"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="number" step="any" class="form-control"
                                                onmouseover="bigOne()" onkeyup="bigOne()" readonly
                                                id="TotalNetAmountDollar">
                                        </div>
                                        <hr>
                                        <div class="col-md-12">
                                            <label for="TotalDiscount" class="form-label">إجمالى خصم الأصناف
                                                بالجنيه</label>
                                        ...
                                        <div class="col-12">
                                            <label for="ExtraInvoiceDiscount" class="form-label">الخصم الإضافى (مابعد
                                                الضريبة) </label>
                                            <input type="number" class="form-control" step="any"
                                                name="ExtraDiscount" id="ExtraDiscount" onkeyup="bigOne()"
                                                value="0" onmouseover="bigOne()" required>
                                        </div>
        ...
        $(document).ready(function() {
            ...
            $("#addNewOne").click(function() {
                ...
                $('<script> function bigOne' + i +
                    '(){ var  currency = document.getElementById("currencyExchangeRate").value; var dollar = document.getElementById("amountSold' +
                    i +
                    '").value; var x = currency * dollar; document.getElementById("amountEGP' + i +
                    '").value = x.toFixed(5); var quantity = document.getElementById("quantity' + i +
                    ...
                    '.value * amounEGP.value).toFixed(2);var allNetTotal = netTotal.value = (salesTotal.value - discount.value).toFixed(2);t2valueEnd.value = ((allNetTotal* T2rate.value) / 100).toFixed(2);t4Amount.value = ((allNetTotal* T4ValueEnd.value) / 100).toFixed(2);totalItemDiscount.value = (parseFloat(netTotal.value) + parseFloat(t2valueEnd.value) - parseFloat(t4Amount.value) - parseFloat(itemsDiscount.value)).toFixed(2);var salesTotalDollar = document.getElementById("salesTotalDollar' +
                    i +
                    '");salesTotalDollar.value = (salesTotal.value / currency).toFixed(2);var netTotalDollar = document.getElementById("netTotalDollar' +
                    i +
                    '");netTotalDollar.value = (netTotal.value / currency).toFixed(2);var t2valueEndDollar = document.getElementById("t2Dollar' +
                    i +
                    '");t2valueEndDollar.value = (t2valueEnd.value / currency).toFixed(2);var t4AmountDollar = document.getElementById("t4AmountDollar' +
                    i +
                    '");t4AmountDollar.value = (t4Amount.value / currency).toFixed(2);var totalItemDiscountDollar = document.getElementById("totalItemsDiscountDollar' +
                    i +
    ...
    <script id="test123">
        ...
        function bigOne() {
            ...
            document.getElementById('totalAmountDollar').value = (document.getElementById("totalAmount").value / currency)
                .toFixed(2);

            document.getElementById("totalAmount2").value = (totalAmountOfDiscount.value - ExtraDiscount.value).toFixed(2);
            document.getElementById('totalAmount2Dollar').value = (document.getElementById("totalAmount2").value / currency)
                .toFixed(2);
