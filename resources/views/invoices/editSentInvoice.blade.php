                        ...
                        <div class="col-6">
                            ...
                            <div>
                                <select name="receiverType" class="form-control text-center form-select">
                                    <option value="B" {{ $jsonData['jsondata']['documents'][0]['receiver']['type']=='B'
                                        ? 'selected' : '' }} style="font-size: 20px">@lang('site.Company')</option>
                                    <option value="P" {{ $jsonData['jsondata']['documents'][0]['receiver']['type']=='P'
                                        ? 'selected' : '' }} style="font-size: 20px">@lang('site.Person')</option>
                                    <option value="F" {{ $jsonData['jsondata']['documents'][0]['receiver']['type']=='F'
                                        ? 'selected' : '' }} style="font-size: 20px">@lang('site.Forign')</option>
                        ...
                        <div class="col-6">
                            ...
                            <div class="">
                                <input type="text" class="form-control text-center" id="getReceiverName"
                                    name="receiverName"
                                    value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['name']) ? $jsonData['jsondata']['documents'][0]['receiver']['name'] : '' }}"
                        ...
                        <div class="invoice-address-client-fields">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="">
                                        <input type="number" id="getReceiverId" style="width:350px"
                                            ...
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['id']) ? $jsonData['jsondata']['documents'][0]['receiver']['id'] : '' }}"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control text-center" id="getReceiverCountry"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['country']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['country'] : '' }}"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="">
                                        <input type="text" id="getReceiverGovernate" class="form-control text-center"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['governate']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['governate'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getReceiverRegionCity" class="form-control text-center"
                                            name="receiverRegionCity"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['regionCity']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['regionCity'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getStreet" class="form-control text-center"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['street']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['street'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getBuildingNumber" class="form-control  text-center"
                                            name="receiverBuildingNumber"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['buildingNumber']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['buildingNumber'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getPostalCode" class="form-control text-center"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['postalcode']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['postalcode'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getFloor" class="form-control text-center"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['floor']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['floor'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getRoom" class="form-control text-center"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['room']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['room'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getLandMark" class="form-control  text-center"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['landmark']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['landmark'] : '' }}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="text" id="getAdditional" class="form-control text-center"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['receiver']['address']['additionalInformation']) ? $jsonData['jsondata']['documents'][0]['receiver']['address']['additionalInformation'] : '' }}"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="">
                                        <select name="taxpayerActivityCode" class="form-select">
                                            ...
                                            <option
                                                value="{{ isset($jsonData['jsondata']['documents'][0]['taxpayerActivityCode']) && $jsonData['jsondata']['documents'][0]['taxpayerActivityCode'] == $code->code ? $jsonData['jsondata']['documents'][0]['taxpayerActivityCode'] : $code->code }}"
                                                {{ isset($jsonData['jsondata']['documents'][0]['taxpayerActivityCode'])
                                                &&
                                                $jsonData['jsondata']['documents'][0]['taxpayerActivityCode']==$code->
                                                code ? 'selected'
                                                : $code->code }}>

                                                {{ isset($jsonData['jsondata']['documents'][0]['taxpayerActivityCode'])
                                                &&
                                                $jsonData['jsondata']['documents'][0]['taxpayerActivityCode'] ==
                                                $code->code ?
                                                $code->Desc_ar : $code->Desc_ar }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="">
                                        <input type="text" id="purchaseOrderReference" class="form-control text-center"
                                            ...
                                            isset($jsonData['jsondata']['documents'][0]['purchaseOrderReference']) }}
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="">
                                        <input type="date"
                                            value="{{ isset($jsonData['jsondata']['documents'][0]['dateTimeIssued']) ? date('Y-m-d', strtotime($jsonData['jsondata']['documents'][0]['dateTimeIssued'])) : date('Y-m-d') }}"
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control text-center" id="internalId"
                                        ...
                                        value="{{ isset($jsonData['jsondata']['documents'][0]['internalID']) ? $jsonData['jsondata']['documents'][0]['internalID'] : '' }}">
                                        ...
                                        <div class="accordion-body" id="newOne">
                                            ...
                                            <div class="row{{ $key + 1 }}" id="row{{ $key + 1 }}">
                                                <button type="button" onclick="RemoveRow({{ $key + 1 }})"
                                                    style="margin-right:30px" name="remove" id="{{ $key + 1 }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="invoiceDescription[]" required class="form-control"
                                                        ...
                                                        rows="2">{{ $line['description'] }}</textarea>
                                                </div>
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <label for="linePrice"
                                                ...
                                                <div class=" row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="t1subtype[]" required id="t1subtype{{ $key + 1 }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input value="{{ $taxItem['rate'] }}" type="number"
                                                            class="form-control" name="rate[]" id="rate{{ $key + 1 }}"
                                                ...
                                                <div class="row g-3 mt-1">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            ...
                                                            name="itemsDiscount[]" id="itemsDiscount{{ $key + 1 }}"
                                                            onkeyup="calculateTotals({{ $key + 1 }}),bigOne()"
                                                            onmouseover="calculateTotals({{ $key + 1 }}),bigOne()"
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" readonly class="form-control"
                                                                    step="any" name="t2Amount[]" id="t2{{ $key + 1 }}"
                                                                    onkeyup="calculateTotals({{ $key + 1 }}),bigOne()"
                                                                    onmouseover="calculateTotals({{ $key + 1 }}),bigOne()"
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" class="form-control" readonly
                                                                    name="netTotal[]" id="netTotal{{ $key + 1 }}"
                                                                    value="{{ $line['netTotal'] }}"
                                                                    onkeyup="calculateTotals({{ $key + 1 }}),bigOne()"
                                                                    onmouseover="calculateTotals({{ $key + 1 }}),bigOne()"
                            ...
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control"
                                            value="{{ $DataOfJson['totalDiscountAmount'] }}" name="totalDiscountAmount"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" step="any" name="TotalSalesAmount"
                                            value="{{ $DataOfJson['totalSalesAmount'] }}" onmouseover="bigOne()"
                                            onkeyup="bigOne()" readonly id="TotalSalesAmount">
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" step="any" class="form-control" name="TotalNetAmount"
                                            value="{{ $DataOfJson['netAmount'] }}" onmouseover="bigOne()"
                                            onkeyup="bigOne()" readonly id="TotalNetAmount">
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" step="any" name="totalItemsDiscountAmount"
                                            value="{{ $DataOfJson['totalItemsDiscountAmount'] }}" class="form-control"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="number" class="form-control" step="any" name="ExtraDiscount"
                                            value="{{ $DataOfJson['extraDiscountAmount'] }}" id="ExtraDiscount"
                                            value="0" onkeyup="bigOne()" onmouseover="bigOne()" required>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-grid col-12" onmouseover="bigOne()">
                                                <button type="submit" class="btn btn-primary" name="action"
                                                    ...
                                                    formaction="{{ route('draft') }}">تعديل و حفظ</button>
                                                <button disabled style="display: none" class="btn btn-primary"
