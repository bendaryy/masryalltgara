                        ...
                        <div class="col-6">
                            ...
                            <div>
                                <select name="receiverType" class="form-control text-center form-select">
                                    <option value="B" {{ $jsonData['jsondata']['receiver']['type']=='B' ? 'selected'
                                        : '' }} style="font-size: 20px">@lang('site.Company')</option>
                                    <option value="P" {{ $jsonData['jsondata']['receiver']['type']=='P' ? 'selected'
                                        : '' }} style="font-size: 20px">@lang('site.Person')</option>
                                    <option value="F" {{ $jsonData['jsondata']['receiver']['type']=='F' ? 'selected'
                                    ...
                                    <div class="">
                                        <select name="taxpayerActivityCode" class="form-select">
                                            ...
                                            <option
                                                ...
                                                {{ isset($jsonData['jsondata']['taxpayerActivityCode']) &&
                                                $jsonData['jsondata']['taxpayerActivityCode']==$code->code ? 'selected'
                                                : $code->code }}>

                                                {{ isset($jsonData['jsondata']['taxpayerActivityCode']) &&
                                                $jsonData['jsondata']['taxpayerActivityCode'] == $code->code ?
