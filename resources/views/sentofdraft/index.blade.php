                ...
                <table id="example2" class="table table-striped table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endisset
                            <td>{{
                                Carbon\Carbon::parse($sent['jsondata']['documents'][0]['dateTimeIssued'])->format('d-m-Y')
                                }}
                            </td>
                            ...
                            <td> <a class="btn btn-success" href="{{ route('pdfEnglish', $sent->uuid) }}"
                                    target="_blank">
                            ...
                            <td>
                                <!-- Edit Button -->
                                <a href="{{ route('editsentinvoice', $sent->id) }}" class="btn btn-primary">تعديل</a>
