...
// return $product['result'];
    ...
    public function createProduct(){
        $allCodes= DB::table('EgsCodes')->get();
        return view('products.creategscodes',compact('allCodes'));
    }
    ...
    public function StoreProduct(Request $request)
    {
        ...
        DB::table('EgsCodes')->insert($data);
        return redirect()->back()->with('message','تم ادخال الكود بنجاح');
    }
